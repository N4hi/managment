...
class fillsClass:
    def __init__(self, root):
        ...
        srch_lbl = Button(self.root, text="البحث", bg="white", fg='#1E2A5E', font=("arial", 20))
        srch_lbl.place(x=900, y=40)
    ...
    def remove_btn(self):
        ...
        if selected_item:
            ...
            if confirm:
                ...
                self.load_items()
                messagebox.showinfo("نجاح", "تم حذف التعبئة بنجاح", parent=self.root)
        else:
            messagebox.showwarning("تحذير", "يرجى اختيار العنصر المطلوب حذفه", parent=self.root)
